...
mean_handle = plt.Line2D((0,1),(0,0), color=colorbrewer(1), linestyle='-', linewidth=1, label='Mean')
MAP_handle = plt.Line2D((0,1),(0,0), color=colorbrewer(0), linestyle='-', linewidth=1, label='MAP')
data_handle = plt.Line2D([], [], color='k', linewidth=0, marker='o', markersize=4, label='data')
plt.subplot(211)

plt.legend(handles=[mean_handle, MAP_handle, data_handle],
