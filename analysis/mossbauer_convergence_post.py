...
columns = ['prior_W','prior_mse','prior_mse_err','prior_bias', 'prior_bias_err','prior_var','prior_var_err']
columns += ['mis_W','mis_mse','mis_mse_err','mis_bias', 'mis_bias_err','mis_var','mis_var_err']
...
np.savetxt("plot_data/mossbauer_convergence.csv", mat, delimiter=",", header=','.join(columns),comments='')
